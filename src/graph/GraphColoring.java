...
public class GraphColoring {
    ...
    public void WelshPowell(){
        ...
        Set<Vertex<Integer>> sortedSet = new TreeSet<>(c);
        ...
        Set<Vertex<Integer>> removeSet = new HashSet<>();
    ...
    public void colorGraph(){
        ...
        Map<String,Boolean> colorsUsed = new HashMap<>();
        colorsUsed.put("Green", false);
        colorsUsed.put("Blue", false);
        colorsUsed.put("Red", false);
        colorsUsed.put("Yellow", false);

        Map<Long,String> colorsAssigned = new HashMap<>();
